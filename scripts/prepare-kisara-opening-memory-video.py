...
SOURCE = ROOT / "kisara" / "001.mp4"
ASSET_DIR = ROOT / "public" / "themes" / "kisara" / "assets"
OUTPUT_VIDEO = ASSET_DIR / "opening-memory-001.mp4"
OUTPUT_FIRST = ASSET_DIR / "opening-memory-001-first.webp"
OUTPUT_LAST = ASSET_DIR / "opening-memory-001-last.webp"
...
def extract_posters() -> None:
    ...
    save_webp(last_frame, OUTPUT_LAST, quality=88)

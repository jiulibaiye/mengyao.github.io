...
key: "aobuta",
title: "青春猪头少年系列",
subtitle: "Rascal Does Not Dream",
},
...
key: "railgun",
title: "某科学的超电磁炮",
subtitle: "A Certain Scientific Railgun",
},
] as const;
...
{ key: "the-finals", title: "终极对决", subtitle: "THE FINALS" },
...
{
label: "正在学习",
text: "UE5 的场景、材质和蓝图，把脑内小房间慢慢搭出来。",
},
{
label: "最近在折腾",
text: "AstrBot 插件、部署教程，以及能让博客动起来的小机关。",
},
{
label: "今日电波",
text: "技术可以严谨一点，呈现方式可以更像玩具一点。",
},
] as const;
